...
HD_PWD='C:/Users/nniro/OneDrive/Desktop/Neaz/project_123/project_123.runs/design_uart_ilmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_uart_ilmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_uart_ilmb_bram_if_cntlr_1.tcl

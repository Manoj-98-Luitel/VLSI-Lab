...
HD_PWD='C:/Users/nniro/OneDrive/Desktop/Neaz/project_123/project_123.runs/design_uart_clk_wiz_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_uart_clk_wiz_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_uart_clk_wiz_1_1.tcl

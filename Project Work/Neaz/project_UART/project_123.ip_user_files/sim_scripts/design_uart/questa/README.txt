...
#
# Generated by export_simulation on Fri Jan 13 14:13:27 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './design_uart.sh' script.

./design_uart.sh -reset_run
...
./design_uart.sh -noclean_files

For more information on the script, please type './design_uart.sh -help'.
